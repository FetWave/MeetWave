...
namespace MeetWave.Migrations
{
    ...
    [Migration("20240920183006_eventInventoryPriority")]
    partial class eventInventoryPriority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetWave.Data.DTOs.Events.CheckinCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MeetWave.Data.DTOs.Payments.EventInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ItemAvailableCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeetWave.Data.DTOs.Events.CheckinCode", b =>
                {
                    b.HasOne("MeetWave.Data.DTOs.Events.EventRSVP", "Rsvp")
                        .WithMany("CheckinCodes")
            ...
            modelBuilder.Entity("MeetWave.Data.DTOs.Payments.OrderLineItem", b =>
                {
                    b.HasOne("MeetWave.Data.DTOs.Payments.EventInventory", "Inventory")
                        .WithMany("LineItems")
